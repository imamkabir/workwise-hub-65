...
import { Camera, Mic, MapPin, Thermometer, Activity, Bluetooth, Usb, HardDrive, Monitor, Gamepad2, Headphones, Keyboard, Mouse, Printer, Scan as Scanner, Webcam, Smartphone, Tablet, Laptop, LampDesk as Desktop, Server, Database, Cloud, Wifi, Signal, Battery, Power, Cpu, MemoryStick, CircuitBoard, Microchip, Zap, Bolt, Slash as Flash, Sparkles, Star, Rocket, Satellite, Radar, Radio, Antenna, Globe, Navigation, Compass, Map, Route, Car, Plane, Ship, Train, Bike, Wallet as Walk, Sun as Run, Heart, Brain, Eye, Ear, Hand, Fingerprint, Shield, Lock, Unlock, Key, UserCheck, UserX, Users, User, Crown, Award, Medal, Trophy, Target, Crosshair, Focus, Scan, Search, Filter, SortAsc as Sort, List, Grid, Layout, Sidebar, Menu, MoreHorizontal, MoreVertical, ChevronUp, ChevronDown, ChevronLeft, ChevronRight, ArrowUp, ArrowDown, ArrowLeft, ArrowRight, CornerUpLeft, CornerUpRight, CornerDownLeft, CornerDownRight, Move, MousePointer, Hand as HandIcon, Grab, GrabIcon } from 'lucide-react';
